        ...
        <el-row :gutter="20">
            <el-col :span="10">
                <div class="grid-content bg-purple">
                    <div ref="motorcycle" class="moto"></div>
                </div>
            </el-col>
            <el-col :span="10">
                <div class="grid-content bg-purple">
...
export default {
    ...
    mounted() {
        console.log();
        var myChart = echarts.init(this.$refs.motorcycle);
        const option = {
            backgroundColor: '#000',
            tooltip: {
                formatter: '{a} <br/>{b} : {c}%'
        ...
        // request.get('https://echarts.apache.org/examples/data-gl/asset/data/flights.json').then(res => {
        //     console.log(res, 'res')
        // })
